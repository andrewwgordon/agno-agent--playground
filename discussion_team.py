...
if __name__ == "__main__":
    asyncio.run(
        agent_team.print_response(
            message="Start the discussion on the topic: 'What is the best approach to realising innovation and agility in a large company that has a heritage of high regulation and risk adverse culture?'",
            stream=True,
